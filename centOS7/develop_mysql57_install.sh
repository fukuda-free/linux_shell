...
# sudo yum -y install "mysql" mysql-community-server mysql-community-devel --skip-broken
# mysqld --version
...
# yumリポジトリel7をインストール
yum install https://dev.mysql.com/get/mysql80-community-release-el7-x.noarch.rpm
# sudo rpm -Uvh http://dev.mysql.com/get/mysql57-community-release-el7-7.noarch.rpm


# mysqlインストール
sudo yum -y update
sudo yum -y install mysql-community-server mysql-community-devel --skip-broken
